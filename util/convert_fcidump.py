...
def conv_rhf(filename):
    ...
    for name in filename:
        ...
        group = [twobody,twobody,twobody,twobody,onebody,onebody,const]
...
def main():
    ...
    if args[0] == "-u":
        ...
        raise Exception("integral type flag must be -u or -r")
